;(function () {
	...
	*/
	...
	FastClick.prototype.onTouchStart = function(event) {
		...
		// Sometimes touchStartTime is less than lastClickTime after ios wakes up, so the click event cannot be triggered,so use absolute value
		if ((Math.abs(touchStartTime - this.lastClickTime)) < this.tapDelay) {
			event.preventDefault();
		}
